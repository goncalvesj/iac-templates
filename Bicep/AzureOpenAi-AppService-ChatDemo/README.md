# Azure Open AI Chat Demo

Set of Bicep templates to deploy a demo chat application using Azure App Service and Azure Open AI.

Deploys an Azure App Service with an application that uses Azure Open AI to generate text based on user input.

App Service is deployed with a Docker image based on this GH Repo:
...
azd up
```
More information on azd can be found below.
